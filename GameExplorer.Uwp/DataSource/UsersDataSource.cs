...
namespace GameExplorer.Uwp.DataSource
{
    ...
    public static class UsersDataSource
    {
        ...
        /// <returns></returns>
        public static async Task<User> Get(Guid uid)
        {
        ...
        /// <returns></returns>
        public static async Task<bool> Delete(User item)
        {
        ...
        /// <param name="item">The item.</param>
        /// <returns></returns>
        public static async Task<bool> Add(User item)
        {
        ...
        /// <param name="item">The item.</param>
        /// <returns></returns>
        public static async Task<bool> Update(User item)
        {
            var postBody = JsonConvert.SerializeObject(item, Formatting.None, new JsonSerializerSettings()
            {
                ReferenceLoopHandling = ReferenceLoopHandling.Ignore
