...
namespace GameExplorer.Uwp.DataSource
{
    ...
    /// 
    /// </summary>
    public static class QuestsDataSource
    {
        /// <summary>
        /// The controller
        /// </summary>
        private const string Controller = "Quests";
        /// <summary>
        /// The base URI
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static async Task<Quest[]> Get()
        {
        ...
        /// <returns></returns>
        public static async Task<Quest> Get(Guid uid)
        {
        ...
        /// <returns></returns>
        public static async Task<bool> Delete(Quest item)
        {
        ...
        /// <param name="item">The item.</param>
        /// <returns></returns>
        public static async Task<bool> Add(Quest item)
        {
        ...
        /// <param name="item">The item.</param>
        /// <returns></returns>
        public static async Task<bool> Update(Quest item)
        {
            var postBody = JsonConvert.SerializeObject(item, Formatting.None, new JsonSerializerSettings()
            {
                ReferenceLoopHandling = ReferenceLoopHandling.Ignore
