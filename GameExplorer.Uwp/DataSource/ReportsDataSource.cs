...
namespace GameExplorer.Uwp.DataSource
{
    ...
    /// 
    /// </summary>
    public static class ReportsDataSource
    {
        /// <summary>
        /// The controller
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static async Task<Report[]> Get()
        {
        ...
        /// <returns></returns>
        public static async Task<Report> Get(Guid uid)
        {
        ...
        /// <returns></returns>
        public static async Task<bool> Delete(Report item)
        {
        ...
        /// <param name="item">The item.</param>
        /// <returns></returns>
        public static async Task<bool> Add(Report item)
        {
        ...
        /// <param name="item">The item.</param>
        /// <returns></returns>
        public static async Task<bool> Update(Report item)
        {
            var postBody = JsonConvert.SerializeObject(item, Formatting.None, new JsonSerializerSettings()
            {
                ReferenceLoopHandling = ReferenceLoopHandling.Ignore
