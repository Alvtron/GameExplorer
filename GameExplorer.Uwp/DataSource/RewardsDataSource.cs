...
namespace GameExplorer.Uwp.DataSource
{
    ...
    /// 
    /// </summary>
    public static class RewardsDataSource
    {
        /// <summary>
        /// The controller
        /// </summary>
        private const string Controller = "Rewards";
        /// <summary>
        /// The base URI
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static async Task<Reward[]> Get()
        {
            var json = await Client.GetStringAsync(Controller).ConfigureAwait(false);
            return JsonConvert.DeserializeObject<Reward[]>(json);
        }
        ...
        /// <returns></returns>
        public static async Task<Reward> Get(Guid uid)
        {
        ...
        /// <returns></returns>
        public static async Task<bool> Delete(Reward item)
        {
        ...
        /// <param name="item">The item.</param>
        /// <returns></returns>
        public static async Task<bool> Add(Reward item)
        {
        ...
        /// <param name="item">The item.</param>
        /// <returns></returns>
        public static async Task<bool> Update(Reward item)
        {
            var postBody = JsonConvert.SerializeObject(item, Formatting.None, new JsonSerializerSettings()
            {
                ReferenceLoopHandling = ReferenceLoopHandling.Ignore
