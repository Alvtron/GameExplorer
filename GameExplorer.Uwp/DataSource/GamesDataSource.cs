...
namespace GameExplorer.Uwp.DataSource
{
    ...
    /// 
    /// </summary>
    public static class GamesDataSource
    {
        /// <summary>
        /// The controller
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static async Task<Game[]> Get()
        {
        ...
        /// <returns></returns>
        public static async Task<Game> Get(Guid uid)
        {
        ...
        /// <returns></returns>
        public static async Task<bool> Delete(Game item)
        {
        ...
        /// <param name="item">The item.</param>
        /// <returns></returns>
        public static async Task<bool> Add(Game item)
        {
        ...
        /// <param name="item">The item.</param>
        /// <returns></returns>
        public static async Task<bool> Update(Game item)
        {
            var postBody = JsonConvert.SerializeObject(item, Formatting.None, new JsonSerializerSettings()
            {
                ReferenceLoopHandling = ReferenceLoopHandling.Ignore
