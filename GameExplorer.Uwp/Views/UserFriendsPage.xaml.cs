...
namespace GameExplorer.Uwp.Views
{
    ...
    public sealed partial class UserFriendsPage : Page
    {
        /// <summary>
        /// The user data
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserFriendsPage"/> class.
        /// </summary>
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            if (e.Parameter is User user)
            {
                ...
                NavigationService.SetHeaderTitle(user.Username + "'s friends");
            }
            else
            {
                Frame.GoBack();
        ...
        {
            var button = (Button)sender;
            var friend = (User)button.Tag;

            var dialog = new ContentDialog()
            {
                Title = "Remove '" + friend.Username + "'",
                Content = "Are you sure you want to remove '" + friend.Username + "' from your friends list?",
